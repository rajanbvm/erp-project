...
import { BsArrowDownRight, BsArrowUpRight, BsChevronDown } from "react-icons/bs";
    ...
    <>
        ...
        <div className="row align-items-center">
          <div className="col-md-6">
            <div className="welcome-banner-content">
              <h1>Good morning, Andrew Smith!</h1>
      ...
      <div className="dashboard-overview mb-40">
        <div className="overview-header">
          <h2>Overview</h2>
          <Dropdown>
            <Dropdown.Toggle variant="success" className="overview-dropdown" id="dropdown-basic">
              <span>Last 30 days</span>
              <IoChevronDown />
            </Dropdown.Toggle>

            <Dropdown.Menu>
              <Dropdown.Item href="#">Last 15 days</Dropdown.Item>
              ...
              <div className="col-lg-3 col-md-6" key={index}>
                <div className="overview-card">
                  ...
                  <span className="growth-text">
                    <ArrowIcon style={{ color: card?.color }} /> {card?.text}
                  </span>
                </div>
              </div>
            );
      ...
      <div className="dashboard-charts mb-40">
        <div className="row">
          <div className="col-lg-6 col-md-12">
            <div className="revenue-chart chart-box">
          ...
          <div className="col-lg-6 col-md-12">
            <div className="sales-funnel chart-box">
              <div className="chart-header">
                <h3>Revenue</h3>
                <Dropdown className="table-dropdown">
                  <Dropdown.Toggle variant="success" className="chart-dropdown" id="dropdown-basic">
